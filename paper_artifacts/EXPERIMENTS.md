...
**Random**（增益 = (A−C)/C；注意与 temporal 基准不同！）

| 档 | A（500ep 充分收敛）| ft-clean | ft-noisy05 | ft-noisy20 |
|---|---|---|---|---|
| 5% | 1.107 ± 0.022（s54-56）| 0.974 ± 0.012，**+13.7%** | 0.981，+12.8% | 0.991，+11.7% |
| 1% | 1.483 ± 0.039（s54/56/58）| 1.076 ± 0.010，**+37.8%** | 1.057，+40.2% | 1.147，+29.2% |

> 2026-09-03 §57 更新：1% A 档 seed 集 = {s54, s56, s58}（s55 确定性坏 basin 0.2316 剔除；s58 resume 好 basin
> 0.0435@247，nrmse 1.5374%，见 progress2.md §57.3）。旧 {s54/56/57} = 1.464±0.012/+36.1% 已由 1.483±0.039/+37.8% 取代。
