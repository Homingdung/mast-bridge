...
MODELS = {
    "5pct-ft": "temporal-ft-5pct-s54-lr1e4-ep100",
    "5pct-scratch": "temporal-scratch-5pct-s54-lr1e4-ep100",
    "1pct-ft": "temporal-ft-1pct-s54-lr1e4-ep100",
}
...
def main():
    ...
    out = OUT_DIR / f"lcfs_pred_{shot}_{model}.png"
