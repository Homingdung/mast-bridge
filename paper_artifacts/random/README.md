...
|---|---|---|---|---|---|
| 5% | 1.107 ± 0.022 | 0.974 ± 0.012 | +13.7% | 0.981 | 0.991 |
| 1% | 1.483 ± 0.039 | 1.076 ± 0.010 | +37.8% | 1.057 | 1.147 |
...
{54,56,58} 均值 **1.483 ± 0.039**（原 {54,56,57} = 1.464 ± 0.012）；C 不动 → 增益 +36.1% → +37.8%，结论不变）
